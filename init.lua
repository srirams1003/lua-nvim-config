...
-- Key mapping
vim.api.nvim_set_keymap('n', '<Leader>b', '<cmd>lua ToggleMouse()<CR>', { noremap = true, silent = true })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Stuff I added
      vim.keymap.set('n', '<leader>n', builtin.buffers, { desc = '[ ] Find existing buffers' })
